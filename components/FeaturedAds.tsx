...
import { FeaturedAd, FeaturedAdsProps } from '@/types/featured-ads';

export default function FeaturedAds({ ads: propAds }: FeaturedAdsProps) {
  // Mock data for featured ads - this would come from an API in production
  const featuredAds: FeaturedAd[] = propAds || [
    {
      id: 1,
